...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-github/internal/eda/utils"
...
func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &githubProvider{version: ver}
	}
}
...
func (p *githubProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewGitHubActionListDataSource,
		NewGitHubInstanceDataSource,
		NewGitHubInstanceListDataSource,
		NewGitHubIssueDataSource,
		NewGitHubIssueListDataSource,
		NewResourceListDataSource,
		NewRunGithubWorkflowDataSource,
		NewRunGithubWorkflowListDataSource,
