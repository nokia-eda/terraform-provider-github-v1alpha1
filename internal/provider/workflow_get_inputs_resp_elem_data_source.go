...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-github/internal/datasource_workflow_get_inputs_resp_elem"
...
const read_ds_workflowGetInputsRespElem = "/workflows/v1/github.eda.nokia.com/v1alpha1/namespaces/{namespace}/creategithubissues/{name}/_input"
