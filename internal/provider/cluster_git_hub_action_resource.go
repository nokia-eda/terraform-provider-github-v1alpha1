...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-github/internal/resource_cluster_git_hub_action"
...
var (
	_ resource.Resource                = (*clusterGitHubActionResource)(nil)
	_ resource.ResourceWithConfigure   = (*clusterGitHubActionResource)(nil)
	_ resource.ResourceWithImportState = (*clusterGitHubActionResource)(nil)
)

func NewClusterGitHubActionResource() resource.Resource {
	return &clusterGitHubActionResource{}
}

type clusterGitHubActionResource struct {
	client *apiclient.EdaApiClient
}

func (r *clusterGitHubActionResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cluster_git_hub_action"
}

func (r *clusterGitHubActionResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_cluster_git_hub_action.ClusterGitHubActionResourceSchema(ctx)
}

func (r *clusterGitHubActionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_cluster_git_hub_action.ClusterGitHubActionModel
	...
	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_clusterGitHubAction,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *clusterGitHubActionResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data resource_cluster_git_hub_action.ClusterGitHubActionModel
...
func (r *clusterGitHubActionResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data resource_cluster_git_hub_action.ClusterGitHubActionModel
	...
	tflog.Info(ctx, "Update()::API request", map[string]any{
		"path": update_rs_clusterGitHubAction,
		"body": spew.Sdump(reqBody),
	})
...
func (r *clusterGitHubActionResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data resource_cluster_git_hub_action.ClusterGitHubActionModel
	...
	tflog.Info(ctx, "Delete()::API request", map[string]any{
		"path": delete_rs_clusterGitHubAction,
		"data": spew.Sdump(data),
	})
...
func (r *clusterGitHubActionResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
