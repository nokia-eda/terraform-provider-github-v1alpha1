...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-github/internal/resource_git_hub_issue"
	"github.com/nokia/eda/apps/terraform-provider-github/internal/tfutils"
)

const (
	create_rs_gitHubIssue = "/apps/github.eda.nokia.com/v1alpha1/namespaces/{namespace}/githubissues"
	read_rs_gitHubIssue   = "/apps/github.eda.nokia.com/v1alpha1/namespaces/{namespace}/githubissues/{name}"
	update_rs_gitHubIssue = "/apps/github.eda.nokia.com/v1alpha1/namespaces/{namespace}/githubissues/{name}"
	delete_rs_gitHubIssue = "/apps/github.eda.nokia.com/v1alpha1/namespaces/{namespace}/githubissues/{name}"
)

var (
	_ resource.Resource                = (*gitHubIssueResource)(nil)
	_ resource.ResourceWithConfigure   = (*gitHubIssueResource)(nil)
	_ resource.ResourceWithImportState = (*gitHubIssueResource)(nil)
)
...
func (r *gitHubIssueResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_gitHubIssue, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_gitHubIssue, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_gitHubIssue,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *gitHubIssueResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_gitHubIssue, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *gitHubIssueResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_gitHubIssue, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *gitHubIssueResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
