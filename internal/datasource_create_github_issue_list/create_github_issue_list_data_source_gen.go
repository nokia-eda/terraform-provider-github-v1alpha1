...
package datasource_create_github_issue_list
...
func CreateGithubIssueListDataSourceSchema(ctx context.Context) schema.Schema {
...
type CreateGithubIssueListModel struct {
