...
package resource_git_hub_issue
...
func GitHubIssueResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^GitHubIssue$"), ""),
				},
				Default: stringdefault.StaticString("GitHubIssue"),
			},
			...
			"name": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "name of the GitHubIssue",
				MarkdownDescription: "name of the GitHubIssue",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				Optional:            true,
				Computed:            true,
				Description:         "status defines the observed state of GitHubIssue",
				MarkdownDescription: "status defines the observed state of GitHubIssue",
			},
		},
	}
}

type GitHubIssueModel struct {
