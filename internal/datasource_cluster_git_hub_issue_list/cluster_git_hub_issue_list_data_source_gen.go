...
package datasource_cluster_git_hub_issue_list
...
func ClusterGitHubIssueListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ClusterGitHubIssueListModel struct {
