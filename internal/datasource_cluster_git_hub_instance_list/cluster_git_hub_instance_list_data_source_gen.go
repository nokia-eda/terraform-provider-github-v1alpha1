...
package datasource_cluster_git_hub_instance_list
...
func ClusterGitHubInstanceListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ClusterGitHubInstanceListModel struct {
