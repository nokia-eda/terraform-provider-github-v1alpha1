...
package resource_run_github_workflow
...
func RunGithubWorkflowResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^RunGithubWorkflow$"), ""),
				},
				Default: stringdefault.StaticString("RunGithubWorkflow"),
			},
			...
			"name": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "name of the RunGithubWorkflow",
				MarkdownDescription: "name of the RunGithubWorkflow",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				Optional:            true,
				Computed:            true,
				Description:         "status defines the observed state of RunGithubWorkflow",
				MarkdownDescription: "status defines the observed state of RunGithubWorkflow",
			},
		},
	}
}

type RunGithubWorkflowModel struct {
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	clusterInstanceAttribute, ok := attributes["cluster_instance"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`cluster_instance is missing from object`)

		return nil, diags
	}

	clusterInstanceVal, ok := clusterInstanceAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`cluster_instance expected to be basetypes.StringValue, was: %T`, clusterInstanceAttribute))
	}
	...
	workflowVal, ok := workflowAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`workflow expected to be basetypes.StringValue, was: %T`, workflowAttribute))
	}
	...
	return SpecValue{
		ClusterInstance: clusterInstanceVal,
...
type SpecValue struct {
	ClusterInstance basetypes.StringValue `tfsdk:"cluster_instance"`
	...
	Workflow        basetypes.StringValue `tfsdk:"workflow"`
	state           attr.ValueState
}
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["cluster_instance"] = basetypes.StringType{}.TerraformType(ctx)
	...
	attrTypes["workflow"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.ClusterInstance.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["cluster_instance"] = val
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		"cluster_instance": basetypes.StringType{},
	...
	objVal, diags := types.ObjectValue(
		attributeTypes,
		map[string]attr.Value{
			"cluster_instance": v.ClusterInstance,
			"instance":         v.Instance,
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.ClusterInstance.Equal(other.ClusterInstance) {
		return false
	}
