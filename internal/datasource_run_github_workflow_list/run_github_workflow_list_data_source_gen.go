...
package datasource_run_github_workflow_list
...
func RunGithubWorkflowListDataSourceSchema(ctx context.Context) schema.Schema {
...
type RunGithubWorkflowListModel struct {
