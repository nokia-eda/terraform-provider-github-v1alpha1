...
package resource_cluster_git_hub_issue
...
func ClusterGitHubIssueResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ClusterGitHubIssue$"), ""),
				},
				Default: stringdefault.StaticString("ClusterGitHubIssue"),
			},
			...
			"name": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "name of the ClusterGitHubIssue",
				MarkdownDescription: "name of the ClusterGitHubIssue",
			},
			...
			"status": schema.SingleNestedAttribute{
				...
				Optional:            true,
				Computed:            true,
				Description:         "status defines the observed state of ClusterGitHubIssue",
				MarkdownDescription: "status defines the observed state of ClusterGitHubIssue",
			},
		},
	}
}

type ClusterGitHubIssueModel struct {
