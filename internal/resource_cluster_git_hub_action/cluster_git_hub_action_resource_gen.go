...
package resource_cluster_git_hub_action
...
func ClusterGitHubActionResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ClusterGitHubAction$"), ""),
				},
				Default: stringdefault.StaticString("ClusterGitHubAction"),
			},
			...
			"status": schema.SingleNestedAttribute{
				...
				Optional:            true,
				Computed:            true,
				Description:         "status defines the observed state of ClusterGitHubAction",
				MarkdownDescription: "status defines the observed state of ClusterGitHubAction",
			},
		},
	}
}

type ClusterGitHubActionModel struct {
